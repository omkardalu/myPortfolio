...
const ProjectCard = ({ name, img, description, tools, link, github }) => {
  return (
    <section className="m-4 flex w-[345px] flex-col justify-center rounded-2xl border-2 border-transparent bg-[#ffffff3c] p-3 shadow-2xl backdrop-blur-xs transition-all duration-300 ease-in-out hover:bg-[#ffffff5e]">
