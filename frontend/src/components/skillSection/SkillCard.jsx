const SkillCard = ({ image, skillName }) => {
  return (
    <div className="relative p-4 group flex flex-col items-center justify-center">
      <div className="w-20">
      ...
      <div className="absolute bottom-[-45%] opacity-0 group-hover:opacity-100 transition-opacity duration-450">
        <span className="relative rounded bg-black px-4 py-1 text-white">
